...
COMMENT !
Description: Reads the letter and index values from the index2.dat 
             file then prints each letter in order based on the index array value
			 starting from the last byte of the index array
Name: Adam Fahrer
